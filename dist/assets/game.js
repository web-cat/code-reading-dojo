...
define('game/authenticators/devise', ['exports', 'ember-simple-auth/authenticators/devise', 'ember'], function (exports, _emberSimpleAuthAuthenticatorsDevise, _ember) {
  ...
  exports['default'] = _emberSimpleAuthAuthenticatorsDevise['default'].extend({
    serverTokenEndpoint: 'http://192.168.1.6:3000/users/sign_in',
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    var child1 = (function () {
      ...
      return {
        ...
        statements: [["block", "if", [["subexpr", "eq", [["get", "session.data.email", ["loc", [null, [9, 14], [9, 32]]]], ["get", "user.email", ["loc", [null, [9, 33], [9, 43]]]]], [], ["loc", [null, [9, 10], [9, 44]]]]], [], 0, null, ["loc", [null, [9, 4], [42, 9]]]]],
        locals: ["user"],
        templates: [child0]
      };
    })();
    return {
      ...
      statements: [["block", "if", [["get", "session.isAuthenticated", ["loc", [null, [2, 8], [2, 31]]]]], [], 0, null, ["loc", [null, [2, 2], [4, 9]]]], ["block", "each", [["get", "model", ["loc", [null, [8, 10], [8, 15]]]]], [], 1, null, ["loc", [null, [8, 2], [43, 9]]]]],
      locals: [],
      templates: [child0, child1]
    };
  })());
...
define("game/templates/new", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      statements: [["block", "if", [["get", "session.isAuthenticated", ["loc", [null, [5, 8], [5, 31]]]]], [], 0, 1, ["loc", [null, [5, 2], [9, 9]]]], ["block", "each", [["get", "model", ["loc", [null, [20, 14], [20, 19]]]]], [], 2, null, ["loc", [null, [20, 6], [27, 15]]]], ["block", "each", [["get", "model", ["loc", [null, [32, 14], [32, 19]]]]], [], 3, null, ["loc", [null, [32, 6], [39, 15]]]], ["block", "each", [["get", "model", ["loc", [null, [44, 14], [44, 19]]]]], [], 4, null, ["loc", [null, [44, 6], [51, 15]]]], ["block", "link-to", ["survey"], ["class", "btn btn-primary", "id", "survey"], 5, null, ["loc", [null, [53, 4], [55, 16]]]], ["block", "link-to", ["info"], ["class", "btn btn-primary"], 6, null, ["loc", [null, [56, 4], [58, 16]]]]],
      locals: [],
